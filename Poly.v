...
Proof.
 intros. induction l1 as [| h t IHl1].
  - reflexivity.
...
Lemma map_rev_app_distr : forall (X Y : Type) (f : X -> Y) (l1 l2 : list X),
...
Proof.
 intros X Y f l.
  induction l.
    - reflexivity. 
    - simpl. rewrite <-IHl. rewrite -> map_rev_app_distr. reflexivity.
Qed.
(** [] *)
...
intros. induction l as [|h t IHl].
- simpl. reflexivity.
- simpl. rewrite <- IHl. cbn. reflexivity.
 Qed.
...
calling a function on something will return another function that we
can uses later
 *)
